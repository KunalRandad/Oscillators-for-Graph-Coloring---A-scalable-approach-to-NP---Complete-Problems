...
if __name__ == "__main__":
    ...
    chromatic_number, min_color_blocks = get_chr(P, Adj, order)  # changes here
    ...
    min_chr_n = n_nodes
    min_ind = 0
    min_chr_n_color_blocks = [[i] for i in range(n_nodes)]
    ...
    # plt.savefig('chr'+str(n_nodes)+'.png', dpi=300)
    # plt.show()
    ...
    # plt.savefig('loss'+str(n_nodes)+'.png', dpi=300)
    # plt.show()
