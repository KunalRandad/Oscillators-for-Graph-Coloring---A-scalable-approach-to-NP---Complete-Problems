...
if __name__ == "__main__":
    ...
    adj = np.asarray([[0,1,1], [1,0,1], [1,1,0]], dtype=np.int32)
    phase_init = [0, 120, 20]
    phase_init = np.array(phase_init)* np.pi / 180
    density_original = density(adj)
    num_colors, best_coloring, phi_history = graph_painter_exp_attraction_visual(adj, num_iters, phi_init=phase_init,
